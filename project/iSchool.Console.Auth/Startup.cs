    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            .AddCookie(options =>
            {
                ...
                options.Cookie.Path = "/";
                //options.DataProtectionProvider = DataProtectionProvider.Create(new DirectoryInfo(@"\\10.1.0.8\shared-auth-ticket-keys"));
            ...
            services.AddMvc(options => {
                options.Filters.Add(new Authorization.AuthorizeAttribute());
