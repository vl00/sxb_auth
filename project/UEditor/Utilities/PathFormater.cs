...
namespace UEditor.Utitlies
{
    ...
    {
        public static string Format(string originFileName, string pathFormat, string contentType, out Guid fileID, Guid contentID = default(Guid))
        {
            ...
            pathFormat = pathFormat.Replace("{contentID}", contentID.ToString());
            pathFormat = pathFormat.Replace("{contentType}", contentType);
